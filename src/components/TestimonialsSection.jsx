  ...
  <div className={`absolute z-20 ${className} hidden md:block`}>
    <div className={`relative flex items-end gap-2 ${reverse ? 'flex-row-reverse' : 'flex-row'}`}>
      <div className="bg-white rounded-2xl p-6 shadow-xl w-[350px] lg:w-[420px]">
        <p className="text-brand-900 text-[13px] lg:text-sm mb-4 font-[400] leading-relaxed text-left">
          {text}
        </p>
        <div className="flex items-start flex-col">
          <h6 className="text-brand-900 text-[13px] lg:text-sm font-semibold">{name}</h6>
...
export default function TestimonialsSection() {
  return (
    <section className="py-12 md:py-48 bg-white relative overflow-hidden w-full">
      ...
      <div className="max-w-6xl mx-auto px-4 relative">
        <div className="md:hidden flex flex-col items-center relative z-10">
          <div className="text-center mb-8">
            <h2 className="font-semibold text-3xl text-brand-900 mb-4 tracking-tight">Real Families<br/>Real Results</h2>
            <p className="text-brand-900/60 text-sm px-4">Join thousands of satisfied homeowners who trust Haven to help them make smarter real estate choices.</p>
          </div>
          ...
          <div className="flex flex-col gap-4 w-full">
            <div className="bg-white rounded-2xl p-6 shadow-lg w-full">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h6 className="text-brand-900 text-sm font-semibold">Megan L.</h6>
                  <div className="flex">
                    {[...Array(5)].map((_, i) => <StarIcon key={i} />)}
                  </div>
                </div>
              </div>
              <p className="text-brand-900 text-sm font-[400]">Haven has completely changed the way I shop for homes. I feel confident knowing exactly what the neighborhood is like before we ever make an offer.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg w-full">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h6 className="text-brand-900 text-sm font-semibold">Tina B.</h6>
                  <div className="flex">
                    {[...Array(5)].map((_, i) => <StarIcon key={i} />)}
                  </div>
                </div>
              </div>
              <p className="text-brand-900 text-sm font-[400]">House hunting used to be stressful. Now I check the Haven score, get instant recommendations, and feel great about where we are moving.</p>
            </div>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg w-full">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h6 className="text-brand-900 text-sm font-semibold">Lila M.</h6>
                  <div className="flex">
                    {[...Array(5)].map((_, i) => <StarIcon key={i} />)}
                  </div>
                </div>
              </div>
              <p className="text-brand-900 text-sm font-[400]">After just a week of using Haven, I feel more in control of my family's future than ever before. It's empowering to make informed choices.</p>
            </div>
          </div>
          
          <button className="text-brand-600 font-medium flex items-center gap-2 justify-center mt-8">
        ...
        <div className="hidden md:grid grid-cols-2 gap-4 z-10">
          ...
          <div className="flex flex-col">
            <div className="flex flex-col flex-start mt-20 items-start pl-8">
              <h2 className="font-semibold text-5xl lg:text-[3.2rem] text-brand-900 text-left mb-6 leading-[1.1] tracking-tight">
                Real Families<br/>Real Results
              </h2>
              <button className="text-brand-600 font-medium flex items-center gap-2 hover:opacity-70 transition-opacity">
                read all 3,147+ reviews
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M5 12l14 0"></path><path d="M13 18l6 -6"></path><path d="M13 6l6 6"></path></svg>
              </button>
            </div>
      ...
      />
      <svg width="484" height="813" viewBox="0 0 484 813" fill="none" xmlns="http://www.w3.org/2000/svg" className="absolute hidden md:block w-[600px] h-[600px] -left-[5rem] z-0 top-1/4 text-brand-100">
