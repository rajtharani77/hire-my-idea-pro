...
const BulletIcon = ({ inverted }) => (
  <div className={`flex shrink-0 items-center justify-center w-5 h-5 rounded-full text-brand-900 ${inverted ? 'bg-white' : 'bg-brand-500'}`}>
    ...
    <section className="py-20 md:py-32 bg-white relative w-full overflow-hidden flex flex-col items-center">
      ...
      <div className="max-w-4xl w-full mx-auto px-4 relative z-10 flex flex-col items-center">
        ...
        <div className="text-center mb-16">
          <h2 className="text-brand-900 text-4xl md:text-[3.2rem] font-medium tracking-tight leading-tight">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-3xl">
          ...
          <div className="relative bg-brand-50 rounded-[32px] p-8 md:p-10 flex flex-col justify-between shadow-sm">

            <div className="absolute -top-6 -left-6 w-16 h-16 bg-brand-500 rounded-full flex items-center justify-center shadow-lg border-4 border-white">
              <svg className="text-brand-900" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>
            </div>

            <div>
              <h4 className="text-brand-900 text-lg font-medium mb-2">Monthly</h4>
              <div className="flex items-baseline gap-2 mb-8">
                <span className="text-brand-900 text-[2.75rem] font-semibold leading-none tracking-tight">$14.99</span>
                <span className="text-brand-900/60 text-sm font-medium">/monthly</span>
              </div>

              <ul className="flex flex-col gap-4 mb-10">
                <li className="flex items-center gap-3">
                  <BulletIcon inverted={false} />
                  <span className="text-brand-900 text-[15px] font-medium">Unlimited Searches</span>
                </li>
                <li className="flex items-center gap-3">
                  <BulletIcon inverted={false} />
                  <span className="text-brand-900 text-[15px] font-medium">Unlimited Neighborhood Scans</span>
                </li>
                <li className="flex items-center gap-3">
                  <BulletIcon inverted={false} />
                  <span className="text-brand-900 text-[15px] font-medium">Comprehensive HOA & Cost Data</span>
                </li>
              </ul>
            </div>

            <button className="w-full bg-brand-900 text-white py-3.5 rounded-full font-semibold hover:bg-brand-800 transition-colors shadow-sm">
              Subscribe
            </button>
          </div>
          <div className="bg-brand-800 rounded-[32px] p-8 md:p-10 flex flex-col justify-between shadow-xl">
            <div>
            ...
            <button className="w-full bg-white text-brand-800 py-3.5 rounded-full font-semibold hover:bg-gray-100 transition-colors shadow-sm">
              Subscribe
            </button>
          </div>
